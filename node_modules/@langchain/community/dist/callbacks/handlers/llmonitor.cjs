...
class LLMonitorHandler extends base_1.BaseCallbackHandler {
    constructor(fields = {}) {
        super(fields);
        ...
        if (fields) {
            ...
            this.monitor.init({
                verbose,
                appId: appId ?? (0, env_1.getEnvironmentVariable)("LLMONITOR_APP_ID"),
                apiUrl: apiUrl ?? (0, env_1.getEnvironmentVariable)("LLMONITOR_API_URL"),
            });
        }
    }
